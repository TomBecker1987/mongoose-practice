...
let books = Book.find({rating:{$lt:5}}).sort({author:1})
...
let books = Book.find({genres:"Fiction"}).skip(2).limit(3)
books.then(function(books){
  console.log(books)
})
...
Person.find({"kids.hair":"grey"},function(err,people){
  console.log(people)
})
